...
class MixinClientPackSourceContractTest {
    ...
    void classInitializerHookRunsAfterItsMixinOwnedLoggerIsInitialized() throws Exception {
        Field logger = MixinClientPackSource.class.getDeclaredField("LOGGER_MCEF");
        Method hook = MixinClientPackSource.class.getDeclaredMethod("on_clinit_MCEF", CallbackInfo.class);
