...
public class RinkuExampleMod {
    ...
    public void onTick() {
        if (KEY_MAPPING.consumeClick() && !(Minecraft.getInstance().screen instanceof ExampleScreen)) Minecraft.getInstance().setScreen(new ExampleScreen(Component.literal("Example Screen")));
    }
