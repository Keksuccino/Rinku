...
public class RinkuDownloaderScreen extends Screen {
    ...
    public void render(@NotNull GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        graphics.fill(0, 0, (int) progressBarWidth, (int) progressBarHeight, -1); // bar border
        graphics.fill(2, 2, (int) progressBarWidth - 2, (int) progressBarHeight - 2, -16777215); // bar padding
        graphics.fill(4, 4, (int) ((progressBarWidth - 4) * RinkuDownloadListener.INSTANCE.getProgress()), (int) progressBarHeight - 4, -1); // progress
        matrix.popMatrix();
