...
public class RinkuSettings {
    ...
    public RinkuDownloader.DownloadPolicy createDownloadPolicy() {
        return new RinkuDownloader.DownloadPolicy(downloadMirrorPolicy, enforceDownloadChecksums, downloadConnectTimeoutMs, downloadReadTimeoutMs, downloadMaxArchiveBytes, downloadMaxChecksumBytes, downloadMaxExtractedBytes);
    }
    ...
    public void load() throws IOException {
        ...
        nativeCefLogSeverity = parseLogSeverity(properties.getProperty("cef-native-log-severity"), nativeCefLogSeverity, "cef-native-log-severity");
        consoleLogForwardingMinSeverity = parseLogSeverity(properties.getProperty("cef-console-log-forwarding-min-severity"), consoleLogForwardingMinSeverity, "cef-console-log-forwarding-min-severity");
