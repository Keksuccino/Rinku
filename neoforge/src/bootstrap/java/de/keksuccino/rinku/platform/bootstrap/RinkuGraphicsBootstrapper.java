 ...
 *
 * <p>This provider lives in the outer FML library wrapper, while the normal Rinku mod is nested
 * inside that wrapper. It must stay free of Minecraft, logging, and other UI initialization:
 * touching those here can defeat the ordering that prevents AWT from taking over GLFW's macOS
 * event loop.</p>
 */
